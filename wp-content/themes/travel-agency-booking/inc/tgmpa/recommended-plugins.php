...
function travel_tour_register_required_plugins()
{
    ...
    $plugins = array(
        array(
        'name'     => esc_html__( 'WP Travel Engine', 'travel-agency-booking' ),
        'slug'     => 'wp-travel-engine',
        'required' => false,
    ),
        array(
        'name'     => esc_html__( 'Contact Form 7', 'travel-agency-booking' ),
        'slug'     => 'contact-form-7',
        'required' => false,
    ),
        array(
        'name'     => esc_html__( 'Advanced Import', 'travel-agency-booking' ),
        'slug'     => 'advanced-import',
        'required' => false,
    ),
        array(
        'name'     => esc_html__( 'TBThemes Theme Import', 'travel-agency-booking' ),
