    ...
    <!-- banner-section -->
    <?php require_once DUABAYMAU_THEME_INC_DIR.'/banner-section.php'; ?>
    <!-- banner-section end -->
    <?php //get_sidebar(); ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-7 col-md-12 col-sm-12 title-column">
                    <div class="title-inner">
                        <div class="year-box">
                            <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/icons/year-icon.png" alt=""></figure>
                            <h2>35</h2>
                            <h3>FIONCA</h3>
                        </div>
                        <div class="title">
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/feature-1.jpg" alt=""></figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/feature-2.jpg" alt=""></figure>
                            <div class="lower-content">
                                <div class="inner">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/feature-3.jpg" alt=""></figure>
                            <div class="lower-content">
                                <div class="inner">
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 video-column">
                    <div class="video-inner">
                        <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/about-1.jpg" alt=""></figure>
                        <div class="video-btn">
                            <a href="https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s" class="lightbox-image" data-caption="" style="background-image: url(http://wp.local/wp-content/themes/duabaymau/assets/images/resource/btn-bg.png);"><i class="fas fa-play"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="fluid-container">
            <div class="project-carousel theme-carousel owl-theme owl-carousel owl-dots-none owl-nav-none">
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/gallery/project-1.jpg" alt=""></figure>
                        <div class="lower-content">
                ...
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/gallery/project-2.jpg" alt=""></figure>
                        <div class="lower-content">
                ...
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/gallery/project-3.jpg" alt=""></figure>
                        <div class="lower-content">
                            <p>Corporate Management</p>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_one">
                        <div class="image-box">
                            <div class="pattern-layer" style="background-image: url(http://wp.local/wp-content/themes/duabaymau/assets/images/shape/shape-1.png);"></div>
                            <figure class="image"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/state-1.jpg" alt=""></figure>
                            <div class="award-box">
                                <div class="box">
                                    <figure class="icon-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/icons/icon-1.png" alt=""></figure>
    ...
    <section class="world-cyber bg-color-1">
        <div class="pattern-layer" style="background-image: url(http://wp.local/wp-content/themes/duabaymau/assets/images/shape/shape-2.png);"></div>
        <div class="auto-container">
                ...
                <div class="location-area">
                    <div class="location-box">
                        <div class="address-box">
                            <figure class="icon-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/icons/icon-2.png" alt=""></figure>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 info-column">
                        <div class="info-inner">
                            <figure class="image-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/info-1.jpg" alt=""></figure>
                            <div class="info-box">
                                <figure class="info-logo"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/icons/info-logo.png" alt=""></figure>
    ...
    <!-- testimonial-section -->
    <section class="testimonial-section" style="background-image: url(http://wp.local/wp-content/themes/duabaymau/assets/images/background/testimonial-bg.jpg);">
        <div class="auto-container">
            <div class="title-box">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 title-column">
                ...
                <div class="client-thumb-outer">
                    <div class="client-thumbs-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/testimonial-1.png" alt=""></figure>
                            <div class="info-box">
                                <h5>Robert Smith</h5>
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/testimonial-2.png" alt=""></figure>
                            <div class="info-box">
                                <h5>Christine Eva</h5>
                                <span class="designation">Senior Manager</span>
                            </div>
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/testimonial-3.png" alt=""></figure>
                            <div class="info-box">
                                <h5>Jhon Doe</h5>
                                <span class="designation">Senior Manager</span>
                            </div>
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/testimonial-4.png" alt=""></figure>
                            <div class="info-box">
                                <h5>Robert</h5>
                                <span class="designation">Senior Manager</span>
                            </div>
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/resource/testimonial-5.png" alt=""></figure>
                            <div class="info-box">
                                <h5>Tomas Tom</h5>
                                <span class="designation">Senior Manager</span>
                            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/news/news-1.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <ul class="post-info">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/news/news-2.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <ul class="post-info">
                                    <li>By <a href="index.html">Fionca</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/news/news-3.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <ul class="post-info">
                                    <li>By <a href="index.html">Fionca</a></li>
    ...
    <section class="clients-section">
        <div class="auto-container">
            <div class="clients-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                <figure class="client-logo"><a href="index.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/clients/clients-1.png" alt=""></a></figure>
                <figure class="client-logo"><a href="index.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/clients/clients-2.png" alt=""></a></figure>
                <figure class="client-logo"><a href="index.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/clients/clients-3.png" alt=""></a></figure>
                <figure class="client-logo"><a href="index.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/clients/clients-4.png" alt=""></a></figure>
                <figure class="client-logo"><a href="index.html"><img src="http://wp.local/wp-content/themes/duabaymau/assets/images/clients/clients-5.png" alt=""></a></figure>
            </div>
        </div>
    </section>
    <!-- clients-section end -->
    ...
    <section class="cta-section">
        <div class="pattern-layer" style="background-image: url(http://wp.local/wp-content/themes/duabaymau/assets/images/shape/shape-3.png);"></div>
        <div class="auto-container">
