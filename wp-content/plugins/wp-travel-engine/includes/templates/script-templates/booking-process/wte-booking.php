		...
		<div class="wte-process-tabs">
			<div id="wteProcessTabs" class="wte-process-container">
				...
				<div class="wte-process-tab-controller">
					...
					<button type="button" id="wteProcessNext" data-step="1" class="wte-process-btn wte-process-btn-next" data-label-default="<?php echo esc_attr__( 'Continue', 'wp-travel-engine' ); ?>" data-label-checkout="<?php echo esc_attr__( 'Proceed to checkout', 'wp-travel-engine' ); ?>"><?php esc_html_e( 'Continue', 'wp-travel-engine' ); ?></button>
				</div>
			</div>
		</div>
