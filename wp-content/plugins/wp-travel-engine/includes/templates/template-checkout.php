			...
			<table id="wte-cart-table">
				...
				<tbody>
					<tr>
						...
						<td><?php echo esc_html( $currency_symbol ); ?><span class="total-trip-price"><?php echo esc_html( wte_price_value_format( $trip_totals['total'] ) ); ?></span> <?php echo esc_html( $currency_code ); ?></td>
					</tr>
				</tbody>
			</table>
		</div>
