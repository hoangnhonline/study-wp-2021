			...
			if ( is_array( $fsds ) && count( $fsds ) > 0 ) {
				switch ( $dates_layout ) {
					case 'months_list':
						...
						$availability_txt     = ! empty( $available_months ) && is_array( $available_months ) ? __( 'Available in the following months:', 'wp-travel-engine' ) : __( 'Available throught out the year:', 'wp-travel-engine' );
