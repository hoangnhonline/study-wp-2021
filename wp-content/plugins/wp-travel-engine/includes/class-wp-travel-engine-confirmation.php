...
class Wp_Travel_Engine_Order_Confirmation {
	...
	function wp_travel_engine_confirmation_shortcodes_callback() {
		...
		?>
		<form method="post" id="wp-travel-engine-order-form">
			<?php
			...
			for ( $i = 1; $i <= $pno; $i++ ) {
				...
				<div class='wp-travel-engine-personal-details-wrapper'>
					...
					<?php
						_e( 'Personal details for Traveler: ', 'wp-travel-engine' );
					echo $i;
					?>
					</div>
						...
						foreach ( $personal_options as $key => $value ) {
							...
							<div class='wp-travel-engine-personal-details'>
								...
								switch ( $key ) {
									...
									<input type="<?php echo $value['type']; ?>" name="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" id="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" 
															<?php
															if ( $value['required'] == '1' ) {
																echo 'required';   }
															?>
									...
									<input type="<?php echo $value['type']; ?>" name="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>]" id="<?php echo esc_attr( $key ); ?>" 
															<?php
															if ( $value['required'] == '1' ) {
																echo 'required';   }
															?>
									...
									<select 
										...
										if ( $value['required'] == '1' ) {
											echo 'required';   }
										?>
										 id="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" name="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" data-placeholder="<?php esc_attr_e( 'Choose a field type&hellip;', 'wp-travel-engine' ); ?>" class="wc-enhanced-select" >
									...
									case 'postcode':
										?>
									<label for="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]"><?php _e( $value['label'], 'wp-travel-engine' ); ?></label>
									<input type="text" name="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" id="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" 
																																	<?php
																																	if ( $value['required'] == '1' ) {
																																		echo 'required';   }
																																	?>
									...
									case 'dob':
										?>
									<label for="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]"><?php _e( $value['label'], 'wp-travel-engine' ); ?></label>
									<input class="wp-travel-engine-datetime" type="<?php echo $value['type']; ?>" name="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" id="wp_travel_engine_placeorder_setting[place_order][travelers][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" 
																							  <?php
																								if ( $value['required'] == '1' ) {
																									echo 'required';   }
																								?>
				...
				if ( ! isset( $wp_travel_engine_settings_options['emergency'] ) ) {
					...
					<div class='wp-travel-engine-relation-details-wrapper'>
						...
						<?php
							_e( 'Emergency contact details for Traveler: ', 'wp-travel-engine' );
						echo $i;
						?>
						</div>
								...
								<div class='wp-travel-engine-relation-details'>
									...
									switch ( $key ) {
										...
										case 'fname':
											?>
										<label for="wp_travel_engine_placeorder_setting[place_order][relation][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]"><?php _e( $value['label'], 'wp-travel-engine' ); ?></label>
										<input type="<?php echo $value['type']; ?>" name="wp_travel_engine_placeorder_setting[place_order][relation][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" id="wp_travel_engine_placeorder_setting[place_order][relation][<?php echo esc_attr( $key ); ?>][<?php echo $i; ?>]" 
																<?php
																if ( $value['required'] == '1' ) {
																	echo 'required';   }
																?>
				...
				<?php } ?>
				<?php
				do_action( 'wp_travel_engine_medication_form', $i );
			}
